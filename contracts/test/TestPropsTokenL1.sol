...
contract TestPropsTokenL1 is Initializable, OwnableUpgradeable, ERC20Upgradeable, IPropsToken {
    ...
    function mint(address _account, uint256 _amount) external override {
        require(msg.sender == _minter, "Only a minter can mint new tokens");
