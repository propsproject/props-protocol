...
async function main() {
  ...
  // await deployer
  //   .sendTransaction({
  //     to: "0x5D15373d35F3308E32e164F12d3c31E712eB2Ef4",
  //     data:
  //       "0x7eff275e000000000000000000000000db2a26c267abcd3a968726762525f77098d2594000000000000000000000000023794aaae083f2d6614a5dbba85c60cf4ba745ca",
  //   })
  //   .then((tx) => tx.wait());
}
